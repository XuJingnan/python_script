...
STG_FACT_WTG_10M_READWINDSPEEDAVE = 'READWINDSPEEDAVE'
...
STG_FACT_NO_CONN_NC_ID = 'NC_ID'
STG_FACT_NO_CONN_NC_STARTTIME = 'NC_STARTTIME'
STG_FACT_NO_CONN_NC_STARTTIME_MSEC = 'NC_STARTTIME_MSEC'

## STG_FACT_STANDARD_STATE
STG_FACT_STANDARD_STATE = 'STG_FACT_STANDARD_STATE'
STG_FACT_STANDARD_STATE_WTG_ID = 'WTG_ID'
STG_FACT_STANDARD_STATE_SS_ID = 'SS_ID'
STG_FACT_STANDARD_STATE_SS_STARTTIME = 'SS_STARTTIME'
STG_FACT_STANDARD_STATE_SS_STARTTIME_MSEC = 'SS_STARTTIME_MSEC'

## STG_FACT_HEALTH_STATE
STG_FACT_HEALTH_STATE = 'STG_FACT_HEALTH_STATE'
STG_FACT_HEALTH_STATE_WTG_ID = 'WTG_ID'
STG_FACT_HEALTH_STATE_SC_ID = 'SC_ID'
STG_FACT_HEALTH_STATE_SC_STARTTIME = 'SC_STARTTIME'
STG_FACT_HEALTH_STATE_SC_STARTTIME_MSEC = 'SC_STARTTIME_MSEC'
...
CAL_THEORY_POWER_10M = 'CAL_THEORY_POWER_10M'
CAL_THEORY_APPRODUCTION_10M = 'CAL_THEORY_APPRODUCTION_10M'
CAL_ACTIVE_POWER_10M = 'CAL_ACTIVE_POWER_10M'
...
## IM_PRODUCTION_BASE
IM_PRODUCTION_BASE = 'IM_PRODUCTION_BASE'
PRODUCTION_PER_SECOND = 'PRODUCTION_PER_SECOND'
THEORY_PRODUCTION_PER_SECOND = 'THEORY_PRODUCTION_PER_SECOND'
ACTUAL_PRODUCTION_PER_SECOND = 'ACTUAL_PRODUCTION_PER_SECOND'
